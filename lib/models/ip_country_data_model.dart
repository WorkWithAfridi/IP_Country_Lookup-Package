...
class IpCountryData {
  ...
  @override
  String toString() {
    return 'IpCountryData(ip: $ip, ip_number: $ip_number, ip_version: $ip_version, country_name: $country_name, country_code2: $country_code2, isp: $isp, response_code: $response_code, response_message: $response_message)';
  }
}
